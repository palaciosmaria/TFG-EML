...
dataset= pd.read_csv("/Users/mariapalacios/Desktop/TFG/datasets/Breast_cancer_data.csv")
dataset.head()
...
rf.fit(train_vectors, X_train.target)
print(rf)

pred = rf.predict(test_vectors)
print(sklearn.metrics.f1_score(X_test.target, pred, average='binary'))
